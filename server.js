...
function checkAuth(req, res, next) {
  ...
  // --- LOG TEMPORAR DE DEBUG --- (șterge acest bloc după ce rezolvi problema)
  console.log('--- Verificare cheie API ---');
  console.log('Cheie primită de la aplicație :', JSON.stringify(key));
  console.log('Cheie așteptată (din Render)  :', JSON.stringify(API_KEY));
  console.log('Se potrivesc?                 :', key === API_KEY);
  console.log('-----------------------------');
  // --- SFÂRȘIT LOG TEMPORAR ---
